...
def main(window):
    ...
    setCenter(window)
    palette = QPalette()
    image=QImage("apple/background.jpg")
    ...
    def update():
        ...
        for i, v in enumerate(board):
            ...
            if v==0:
                ...
                pixmap=QPixmap('apple/mac2.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
                
            elif v==4:
                pixmap=QPixmap('apple/mac4.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==8:
                pixmap=QPixmap('apple/mac8.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==16:
                pixmap=QPixmap('apple/mac16.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==32:
                pixmap=QPixmap('apple/mac32.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==64:
                pixmap=QPixmap('apple/mac64.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==128:
                pixmap=QPixmap('apple/mac128.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==256:
                pixmap=QPixmap('apple/mac256.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==512:
                pixmap=QPixmap('apple/mac512.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==1024:
                pixmap=QPixmap('apple/mac1024.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
            elif v==2048:
                pixmap=QPixmap('apple/mac2048.jpg')
                small_pix=pixmap.scaled(sizew,sizeh)
                labels[i].setPixmap(small_pix)
